                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-gray-500">
                      {payer?.name} • {new Date(expense.date).toLocaleDateString('ru-RU', {
                        day: 'numeric',
                        month: 'short',
                        year: 'numeric'
                      })}
                  ...
                  {isExpanded && (
                    ...
                    >
                      <div className="p-4">
                        {/* Дата расхода */}
                        <div className="mb-3">
                          <h4 className="text-sm font-medium text-gray-700 mb-1">Дата расхода</h4>
                        ...
                        {expense.shares && expense.shares.length > 0 && (
                          <div>
                            <h4 className="text-sm font-medium text-gray-700 mb-2">Распределение</h4>
